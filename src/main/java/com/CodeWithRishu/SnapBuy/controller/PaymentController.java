...
public class PaymentController {
    ...
    @PreAuthorize("hasAuthority('ROLE_USER')")
    public ResponseEntity<RazorpayResponse> initiateRazorpayPayment(@RequestBody RazorpayRequest razorpayRequest) throws RazorpayException {
        RazorpayResponse razorpayResponse = paymentService.createOrderByRazorpay(razorpayRequest);
        return ResponseEntity
                .status(HttpStatus.OK)
